        ...
        private static ListItemCollection GetExtraItems(EnumCollection.ListItemType ddltype)
        {
            ...
            switch (ddltype)
            {
                ...
                case EnumCollection.ListItemType.Designation: //for Designation
                    ...
                    break;
                case EnumCollection.ListItemType.PoliceStation: //for PoliceStation
                    extraItems.Add(new ListItem("Select Police Station", "-1"));
                    break;
                ...
                case EnumCollection.ListItemType.UrlList:// for Url List 
                    ...
                    break;
                case EnumCollection.ListItemType.BookCategory:// for Url List 
                    extraItems.Add(new ListItem("Select Category Name ", "-1"));
                    break;

                case EnumCollection.ListItemType.BookPublisher:// for Url List 
                    extraItems.Add(new ListItem("Select Publisher Name ", "-1"));
                    break;
                case EnumCollection.ListItemType.BookAuthor:// for Url List 
                    extraItems.Add(new ListItem("Select Author Name ", "-1"));
                    break;
                case EnumCollection.ListItemType.ParentCategory:// for Url List 
                    extraItems.Add(new ListItem("Select Parent Category Name ", "-1"));
                    break;
                case EnumCollection.ListItemType.BookWishType:// for Url List 
                    extraItems.Add(new ListItem("Select Buying Format ", "-1"));
                    break;
                case EnumCollection.ListItemType.Profession:// for Url List 
                    extraItems.Add(new ListItem("Select a profession", "-1"));
                    break;
                case EnumCollection.ListItemType.CMSTypeID:// forCMS Type
                    extraItems.Add(new ListItem("Select CMS Type", "-1"));
                    break;
