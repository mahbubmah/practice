        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                using (PoliceStationRT receiverTransfer = new PoliceStationRT())
                {
                    ...
                    hdIsEdit.Value = "true";
                    PoliceStation divisionOrState = CreatePoliceStaion();

                    if (divisionOrState != null)
                    {
                        receiverTransfer.UpdatePoliceStaion(divisionOrState);
        ...
        private void FillPoliceStationForEdit(PoliceStation policeStaion)
        {
            try
            {
                if (policeStaion != null)
                {
                    ...
                    LoadDivisionOrStateForCountry(Convert.ToInt32(policeStaion.DivisionOrStateID));
                    LoadDistrictForDivOrStateChage(Convert.ToInt32(policeStaion.DistrictID));
                    ...
                    if (policeStaion.IsRemoved == true)
                    {
