<%@ Page Title="" Language="C#" MasterPageFile="~/BookAdmin/OiiOMasterPage.Master" AutoEventWireup="true" CodeBehind="ProfessionView.aspx.cs" Inherits="OB.Web.BookAdmin.ProfessionView" %>
                    ...
                    <div class="manageAdd">
                        <div class="addPostMang">
                            ...
                            <fieldset class="adminFieldset">
                                <legend>Profession List</legend>

                                <asp:ListView ID="lvProfessions" runat="server" DataKeyNames="IID"
                                    OnPagePropertiesChanging="lvProfessions_PagePropertiesChanging" OnPreRender="dataPagerProfessions_PreRender">
                                    <LayoutTemplate>
                                    ...
                                    <ItemTemplate>
                                        <tr runat="server">
                                            ...
                                            <td>
                                                <asp:Label ID="lblCode" runat="server" Text='<%# Enum.Parse(typeof( OB.Utilities.EnumCollection.type),Eval("Type").ToString())  %>'></asp:Label>
                                            </td>
                                ...
                                <asp:DataPager ID="dataPagerProfessions" runat="server" PagedControlID="lvProfessions"
                                    PageSize="10" OnPreRender="dataPagerProfessions_PreRender">
                                    <Fields>
