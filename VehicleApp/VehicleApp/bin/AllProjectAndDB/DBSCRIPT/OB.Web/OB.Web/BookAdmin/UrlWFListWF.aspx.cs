	...
	public partial class UrlWFListWF : System.Web.UI.Page
	{
        ...
        private void LoadDropDownModule()
        {
            try
            {
                ...
                DropDownListHelper.Bind(dropDownModuleName, EnumHelper.EnumToList<EnumCollection.ModuleList>(),EnumCollection.ListItemType.UrlList);
        ...
        protected void dropDownModuleName_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                //string name = sender.GetType().ToString();
                //int moduleNo = GetModeNoByName(name);

                if (dropDownModuleName != null)
                {
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                using (UrlWFListRT reciveTransfer = new UrlWFListRT())
                {
                    ...
                    {
                        labelMessage.Text = "Url List " + txtUrlWFName.Text + " Used in UserPermission";
                        labelMessage.ForeColor = System.Drawing.Color.Red;
                    }
                    else
                    {
