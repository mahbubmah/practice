<%@ Page Title="" Language="C#" MasterPageFile="~/OiiOInnerMasterPage.Master" AutoEventWireup="true" CodeBehind="BookFiction.aspx.cs" Inherits="OB.Web.BookFiction" %>
    ...
    <div class="ContentArea commonH3titel">
        <div class="row">
            <div class="contArea">
                ...
                <p><a class=" btn btn-success pull-right" href="<%=this.ResolveUrl("~/BookInnerDetails.aspx?Type="+Convert.ToInt32 (OB.Utilities.EnumCollection.ParentCategory.Fiction)) %>">View all Fiction</a></p>
            </div>
        </div>
        <div class="row">
            ...
            <div class="bookBoxWrp">
                <div class="row">
                    <asp:Repeater ID="rpFictionBook" runat="server" OnItemDataBound="rpFictionBook_OnItemDataBound">
                        <ItemTemplate>
