...
<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminMaster.Master" AutoEventWireup="true" CodeBehind="AllNewsDisplay.aspx.cs" Inherits="OMart.Web.AdminPanel.AllNewsDisplay" %>
                    ...
                    <div class="manageAdd">
                        <div class="addPostMang">
                            ...
                            <fieldset class="adminFieldset">
                                <legend>All News List</legend>

                                <asp:ListView ID="lvAllNews" runat="server" DataKeyNames="IID"
                                    OnPagePropertiesChanging="lvAllNews_PagePropertiesChanging" OnPreRender="dataPagerAllNews_PreRender">
                                    <LayoutTemplate>
                                            ...
                                            <thead>
                                                <tr runat="server">
                                                    ...
                                                    <th class="col-xs-3">Title
                                                     ...
                                                     <th class="col-xs-4">Release date
                                                    </th>
                                                    <th>Edit
                                                    </th>
                                                    <th>Delete
                                    ...
                                    <ItemTemplate>
                                        <tr runat="server">
                                            <td style="text-align: center">
                                             ...
                                             <td>
                                                <asp:Label ID="Label5" runat="server" Text='<%# Bind("ReleaseDate","{0:dd-MMM-yyyy}") %>'></asp:Label>
                                            </td>
                                ...
                                <asp:DataPager ID="dataPagerAllNews" runat="server" PagedControlID="lvAllNews"
                                    PageSize="10" OnPreRender="dataPagerAllNews_PreRender">
                                    <Fields>
