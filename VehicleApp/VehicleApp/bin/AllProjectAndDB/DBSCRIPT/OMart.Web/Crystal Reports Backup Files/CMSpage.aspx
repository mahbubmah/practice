<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminMaster.Master" AutoEventWireup="true" CodeBehind="CMSpage.aspx.cs" Inherits="OMart.Web.AdminPanel.CMSpage" %>
                    ...
                    <ItemTemplate>
                        <tr runat="server">
                                            ...
                                            <td>
                                                ...
                                                <asp:Label ID="Label4" runat="server" Text='<%#Enum.Parse(typeof(Utilities.EnumCollection.CMSType), Eval("CMSTypeID").ToString()).ToString().Replace("_"," ")%>'></asp:Label>
                                            </td>
