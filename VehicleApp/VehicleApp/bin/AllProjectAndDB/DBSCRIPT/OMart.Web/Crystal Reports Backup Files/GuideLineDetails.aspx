<%@ Page Title="" Language="C#" MasterPageFile="~/OiiOMasterPage.Master" AutoEventWireup="true" CodeBehind="GuideLineDetails.aspx.cs" Inherits="OMart.Web.GuideLineDetails" %>
                ...
                <div class="row panelBodyTop">
                    <div class="col-md-12 col-sm-12 col-lg-12">
                        <div class="col-md-8 col-sm-8 col-lg-8">
                            <h3>
                                <asp:Literal ID="ltrtype" runat="server" Text='<%# Eval("BussinessTypeName") %>'></asp:Literal>
                            </h3>

                            <h5>
                                <asp:Literal ID="ltrTitle" runat="server" Text='<%# Eval("GuideTypeTitle") %>'></asp:Literal>
                            </h5>

                            <h6>
                                <asp:Literal ID="ltrDes" runat="server" Text='<%# Eval("GuideTypeDescription") %>'></asp:Literal>
                            </h6> 
                        </div> 
                        <div class="col-md-4 col-sm-4 col-lg-4">
                            <div class="thumbnail productimg2 ">
                                <asp:Image ID="img_Guide" runat="server" Height="300" Width="400" ImageUrl='<%# Eval("ImageUrl")%>' AlternateText="img" />
                            </div>
                        </div>
                    </div>
                </div>
