<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminMaster.Master" AutoEventWireup="true" CodeBehind="LIApplicableFeatureView.aspx.cs" Inherits="OMart.Web.AdminPanel.LIApplicableFeatureView" %>
                    ...
                    <div class="manageAdd">
                        <div class="addPostMang">
                            ...
                            <fieldset class="adminFieldset">
                                <legend>Life Insurance Applicable Feature</legend>
                                ...
                                <asp:ListView ID="lvLiSchema" runat="server" DataKeyNames="IID"
                                    ...
                                    <ItemTemplate>
                                        <tr runat="server">
                                            ...
                                            <td>
                                                <asp:Label ID="lblCode" runat="server" Text='<%# Bind("LISchemaID") %>'></asp:Label>
                                            </td>
