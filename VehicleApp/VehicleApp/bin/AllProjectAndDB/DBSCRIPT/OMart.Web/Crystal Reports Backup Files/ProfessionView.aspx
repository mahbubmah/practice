<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ProfessionView.aspx.cs" Inherits="OMart.Web.AdminPanel.ProfessionView" %>
                                ...
                                <asp:ListView ID="lvProfessions" runat="server" DataKeyNames="IID"
                                    ...
                                    <ItemTemplate>
                                        <tr runat="server">
                                            ...
                                            <td>
                                                <asp:Label ID="lblCode" runat="server" Text='<%# Enum.Parse(typeof( Utilities.EnumCollection.type),Eval("Type").ToString())  %>'></asp:Label>
                                            </td>
