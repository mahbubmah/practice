<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminMaster.Master" AutoEventWireup="true" CodeBehind="UrlWFListWF.aspx.cs" Inherits="OMart.Web.AdminPanel.UrlWFListWF" %>
                    ...
                    <div class="manageAdd">
                        <div class="addPostMang">
                            ...
                            <fieldset class="adminFieldset">
                                <legend>Url Lists</legend>

                                <asp:ListView ID="lvUrlWFList" runat="server" DataKeyNames="IID"
                                    OnPagePropertiesChanging="lvUrlList_PagePropertiesChanging" OnPreRender="dataPagerUrlList_PreRender">
                                    <LayoutTemplate>
                                        <table class="table  table-hover table-bordered">
                                            <thead>
                                                <tr runat="server">
                                                    ...
                                                    <th class="col-xs-4">Module Serial No
                                                    </th>
                                                    <th class="col-xs-2">Url Name
                                                    </th>
                                                    <th class="col-xs-2">Url Serial No
                                                    </th>
                                                    <th class="col-xs-2">Url Display Name
                                                    </th>
                                                    <th>Edit
                                                    </th>
                                                    <th>Delete
                                    ...
                                    <ItemTemplate>
                                        <tr runat="server">
                                            ...
                                            <td>
                                                <asp:Label ID="lblISDCode" runat="server" Text='<%# Bind("ISDCode") %>'></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="Label1" runat="server" Text='<%# Bind("ISDCode") %>'></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="Label2" runat="server" Text='<%# Bind("ISDCode") %>'></asp:Label>
                                            </td>
                                            <td>
