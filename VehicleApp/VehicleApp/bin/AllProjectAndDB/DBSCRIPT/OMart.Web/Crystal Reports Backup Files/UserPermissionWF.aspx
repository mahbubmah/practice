<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminMaster.Master" AutoEventWireup="true" CodeBehind="UserPermissionWF.aspx.cs" Inherits="OMart.Web.AdminPanel.UserPermissionWF" %>
            ...
            <div class="row">
                <div class="form-group col-xs-4">
                    <div class="input-group">
                        ...
                        <asp:DropDownList ID="dropDownListGroupName" runat="server" Height="23px" Width="229px"></asp:DropDownList>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="form-group col-xs-4">
                    <div class="input-group">
                        ...
                        <asp:DropDownList ID="dropDownListURLList" runat="server" Height="23px" Width="229px" CssClass="sysTextBox"></asp:DropDownList>
                    </div>
                </div>
            </div>
