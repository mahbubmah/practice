<%@ Page Title="" Language="C#" MasterPageFile="~/OiiOMasterPage.master" AutoEventWireup="true" CodeBehind="UserRegistration.aspx.cs" Inherits="OMart.Web.UserRegistration" %>
            ...
            <div class="row">
                    ...
                    <div class="well signpPageLeft">
                      ...
                      <%--  <div class="row">
                        ...
                        <div class="checkbox multiCkbox">
                            <p class="help-block">(if any promotion, please check the following checkbox.)</p>
                ...
                <div class="col-xs-6">
                    <div class="well signpPageRight">
                        <p class="lead">Get the most form your  <span class="text-danger">OiiO Mart </span>account</p>
                        <ul class="list-unstyled" style="line-height: 2">
                            <li><span class="fa fa-folder-open text-danger1"></span>With a OiiO Mart account, you can manage all your ads in one place.</li>
