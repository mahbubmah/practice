<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminMaster.Master" AutoEventWireup="true" CodeBehind="AllFeatureDisplay.aspx.cs" Inherits="OMart.Web.AdminPanel.AllFeatureDisplay" %>
                    ...
                    <div class="manageAdd">
                        <div class="addPostMang">
                            ...
                            <fieldset class="adminFieldset">
                                <legend>All Feature List</legend>

                                <asp:ListView ID="lvAllFeature" runat="server" DataKeyNames="IID"
                                    OnPagePropertiesChanging="lvAllFeature_PagePropertiesChanging" OnPreRender="lvAllFeature_PreRender">
                                    <LayoutTemplate>
                                            ...
                                            <thead>
                                                <tr runat="server">
                                                    ...
                                                    <th class="col-xs-1">Title
                                                      ...
                                                      <th class="col-xs-2">Business type
                                                    </th>
                                                      <th class="col-xs-2">Business type breakdown
                                                    </th>
                                    ...
                                    <ItemTemplate>
                                        <tr runat="server">
                                            <td style="text-align: center">
                                             ...
                                             <td>
                                                <asp:Label ID="lblCardInfo" runat="server" Text='<%# Bind("TitleName") %>'></asp:Label>
                                            </td>
                                              
                                             <td>
                                                <asp:Label ID="Label2" runat="server" Text='<%# Bind("BussinessTypeName") %>'></asp:Label>
                                            </td>
                                             <td>
                                                <asp:Label ID="Label3" runat="server" Text='<%# Bind("BusinessTypeBreakdownName") %>'></asp:Label>
                                            </td>
                                             <td>
                                ...
                                <asp:DataPager ID="dataPagerAllFeature" runat="server" PagedControlID="lvAllFeature"
                                    PageSize="10" OnPreRender="dataPagerAllFeature_PreRender">
                                    <Fields>
