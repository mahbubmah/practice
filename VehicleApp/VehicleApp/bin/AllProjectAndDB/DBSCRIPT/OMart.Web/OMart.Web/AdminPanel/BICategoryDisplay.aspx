<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminMaster.Master" AutoEventWireup="true" CodeBehind="BICategoryDisplay.aspx.cs" Inherits="OMart.Web.AdminPanel.BICategoryDisplay" %>
                    ...
                    <div class="manageAdd">
                        <div class="addPostMang">
                            <fieldset class="adminFieldset">
                                <legend>Business Category List</legend>
                                <asp:ListView ID="lvBiCategory" runat="server" DataKeyNames="IID"
                                    OnPagePropertiesChanging="lvBiCategory_OnPagePropertiesChanging" OnPreRender="dataPagerBiCategory_OnPreRender">
                                    <LayoutTemplate>
                                    ...
                                    <ItemTemplate>
                                        <tr runat="server">
                                            ...
                                            <td>
                                                <asp:Label ID="lblCardFeature" runat="server" Text='<%# Bind("Name") %>'></asp:Label>
                                            </td>
                                            <td>
                                ...
                                <asp:DataPager ID="dataPagerBusinessAge" runat="server" PagedControlID="lvBiCategory"
                                    PageSize="10" OnPreRender="dataPagerBiCategory_OnPreRender">
                                    <Fields>
