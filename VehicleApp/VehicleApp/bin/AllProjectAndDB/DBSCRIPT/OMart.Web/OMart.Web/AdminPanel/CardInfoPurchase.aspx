<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminMaster.Master" AutoEventWireup="true" CodeBehind="CardInfoPurchase.aspx.cs" Inherits="OMart.Web.AdminPanel.CardInfoPurchase" %>
                    ...
                    <div class="manageAdd">
                        <div class="addPostMang">
                            ...
                            <fieldset class="adminFieldset">
                                <legend>Card informaion List With Purchase Link</legend>
                                            ...
                                            <thead>
                                                <tr runat="server">
                                                    ...
                                                    <th class="col-xs-1">Company name
                                                     ...
                                                     <th class="col-xs-2">Card Logo Url
                                                    </th>
                                                    ...
                                                    <th class="col-xs-1">Post last display date
                                                    </th>
                                    ...
                                    <ItemTemplate>
                                        <tr runat="server">
                                            <td style="text-align: center">
                                             ...
                                             <td>
                                                <asp:Label ID="Label3" runat="server" Text='<%# Bind("CardLogoUrl") %>'></asp:Label>
                                            </td>
                                             <td>
                                                <asp:Label ID="Label4" runat="server" Text='<%# Bind("APR") %>'></asp:Label>
                                            </td>
                                             <td>
                                                <asp:Label ID="Label5" runat="server" Text='<%# Bind("MinimumLimitAmt") %>'></asp:Label>
                                            </td>
                                             <td>
                                                <asp:Label ID="Label6" runat="server" Text='<%# Bind("MaximumLimitAmt") %>'></asp:Label>
                                            </td>
                                             <td>
                                                <asp:Label ID="Label7" runat="server" Text='<%# Bind("AnnualFeePayment") %>'></asp:Label>
                                            </td>
                                             <td>
