<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ChannelInfoView.aspx.cs" Inherits="OMart.Web.AdminPanel.ChannelInfoView" %>
                    ...
                    <div class="manageAdd">
                        <div class="addPostMang">
                            ...
                            <fieldset class="adminFieldset">
                                <legend>Channel Info  List</legend>

                                <asp:ListView ID="lvChannelInfo" runat="server" DataKeyNames="IID"
                                    OnPagePropertiesChanging="lvChannelInfo_PagePropertiesChanging" OnPreRender="dataPagerChannelInfo_PreRender">
                                    <LayoutTemplate>
                                        <table class="table  table-hover table-bordered">
                                            <thead>
                                                <tr runat="server">
                                                    ...
                                                    <th class="col-xs-2">Contact Phone
                                                    </th>
                                    ...
                                    <ItemTemplate>
                                        <tr runat="server">
                                            ...
                                            <td>
                                                <asp:Label ID="lblISDCode" runat="server" Text='<%# Bind("Name") %>'></asp:Label>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <asp:Label ID="Label3" runat="server" Text='<%# Bind("ContactPhone") %>'></asp:Label>
                                            </td>
                                            <td >
                                                <asp:Label ID="lblName" runat="server" Text='<%# Bind("Address") %>'></asp:Label>
                                            </td>
                                            <td >
                                ...
                                <asp:DataPager ID="dataPagerChannelInfo" runat="server" PagedControlID="lvChannelInfo"
                                    PageSize="10" OnPreRender="dataPagerChannelInfo_PreRender">
                                    <Fields>
