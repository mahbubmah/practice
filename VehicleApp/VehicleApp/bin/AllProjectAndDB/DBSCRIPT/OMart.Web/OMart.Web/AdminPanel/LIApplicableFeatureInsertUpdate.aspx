<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminMaster.Master" AutoEventWireup="true" CodeBehind="LIApplicableFeatureInsertUpdate.aspx.cs" Inherits="OMart.Web.AdminPanel.LIApplicableFeatureInsertUpdate" %>
                    ...
                    <div class="manageAdd">
                        <div class="addPostMang">
                            <fieldset class="adminFieldset">
                                <legend>Add/Edit Life Insurance Applicable Feature</legend>
                                <div class="col-xs-6">
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            <div class="col-sm-9 col-md-9">
                                                <asp:Label ID="lblLiSchemaName" runat="server" CssClass="control-label">Description</asp:Label>
