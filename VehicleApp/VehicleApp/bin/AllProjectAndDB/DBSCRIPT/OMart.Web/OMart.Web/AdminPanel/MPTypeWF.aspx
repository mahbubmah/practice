<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminMaster.Master" AutoEventWireup="true" CodeBehind="MPTypeWF.aspx.cs" Inherits="OMart.Web.AdminPanel.MPTypeWF" %>
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            <div class="col-sm-9 col-md-9">
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ValidationGroup="gen" ControlToValidate="txtTypeName"  runat="server" ErrorMessage="Required Name" ForeColor="Red"></asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                                    </div>
                                    <br />
                                            ...
                                            <div class="col-sm-9 col-md-9">
                                               <%-- <asp:Label ID="lblCompanyInfoID" runat="server" CssClass="control-label">Company Info</asp:Label>
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" InitialValue="-1
                                                    " ControlToValidate="dropDownCompanyInfoID" runat="server" ValidationGroup="gen" ErrorMessage="Select Company" ForeColor ="Red"></asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                                    </div>
                                    <br />
