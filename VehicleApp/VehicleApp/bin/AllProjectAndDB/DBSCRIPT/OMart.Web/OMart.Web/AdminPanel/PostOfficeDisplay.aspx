<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminMaster.Master" AutoEventWireup="true" CodeBehind="PostOfficeDisplay.aspx.cs" Inherits="OMart.Web.AdminPanel.PostOfficeDisplay" %>
                    ...
                    <div class="manageAdd">
                        <div class="addPostMang">
                            ...
                            <fieldset class="adminFieldset">
                                <legend>Post office List</legend>

                                <asp:ListView ID="lvPostOffice" runat="server" DataKeyNames="IID"
                                    OnPagePropertiesChanging="lvPostOffice_PagePropertiesChanging" OnPreRender="dataPagerPostOffice_PreRender">
                                    <LayoutTemplate>
                                    ...
                                    <ItemTemplate>
                                        <tr runat="server">
                                            <td style="text-align: center">
                                             ...
                                             <td>
                                                <asp:Label ID="lblLocation" runat="server" Text='<%# Bind("DivisionOrState") %>'></asp:Label>
                                            </td>
                                            <td>
