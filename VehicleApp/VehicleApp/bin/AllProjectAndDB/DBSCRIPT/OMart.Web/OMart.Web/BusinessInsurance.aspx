<%@ Page Title="Business Insurance" Language="C#" MasterPageFile="~/InsuranceMaster.master" AutoEventWireup="true" CodeBehind="BusinessInsurance.aspx.cs" Inherits="OMart.Web.BusinessInsurance" %>
            ...
            <div class="row">
                <div class="col-sm-8 col-md-8 col-lg-8">
                    <div class="lifeInsr_compPart">
                        ...
                        <a class="btn btn-default btnQuote" href="<%=this.ResolveUrl("~/BusinessInsuranceCover.aspx?Type=pnlBuzInsAbout")%>">Start a new quote</a>
                        <p>
