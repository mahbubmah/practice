<%@ Page Title="Home Insurance" Language="C#" MasterPageFile="~/InsuranceMaster.master" AutoEventWireup="true" CodeBehind="HomeInsurance.aspx.cs" Inherits="OMart.Web.HomeInsurance" %>
            ...
            <div class="row">
                <div class="col-sm-8 col-md-8 col-lg-8">
                    <div class="lifeInsr_compPart">
                        ...
                        <h4>Let's compare home insurance</h4>
                        <a class="btn btn-default btnQuote" href="<%=this.ResolveUrl("~/HomeInsuranceCover.aspx?Type=pnlHomeInsCover")%>">Start a new quote</a>
                        <p>
                            We bring you some great deals on your home insurance from our 
panel of providers. 
                        </p>
                        <p>
                            You can call a home Search advisor to discuss your cover; they'll 
answer questions and provide advice to help you decide.
                ...
                <div class="col-sm-4 col-md-4 col-lg-4">
                    <div class="lifeInsr_compPart text-center">
                        ...
                        <a class="btn btn-default btnQuote" href="HomeInsuranceCover.aspx">Retrieve quotes</a>
                ...
                <div class="col-sm-3 col-md-3 col-lg-3">
                    <div class="right_sidebar_ins">
                        <div class="rightSidebarA">
                            <h3>Shop</h3>
                            <p>Need more information about home insurance? Don't worry, we have a list of home insurance shop which may help with your query.</p>
                            <div class="clearfix"></div>
                        </div>
