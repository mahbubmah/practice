<%@ Page Title="" Language="C#" MasterPageFile="~/OiiOMasterPage.master" AutoEventWireup="true" CodeBehind="LoginPage.aspx.cs" Inherits="OMart.Web.LoginPage" %>
                    ...
                    <div class="panel-footer ">
                        <p>
                           <%-- <asp:HyperLink runat="server" ID="RegisterHyperLink" ViewStateMode="Enabled">Register</asp:HyperLink>--%>
                            <a runat="server" id="hrfRegister" href="UserRegistration">Register</a>
