        ...
        private UserInfo CreateaUserInfo()
        {
            ...
            try
            {
                ...
                using (UserInformationRT adGiverRt = new UserInformationRT())
                {
                    ...
                    userRegistration.IsEmail = chkEmail.Checked;
                   // userRegistration.IsSMS = chkSMS.Checked;
                    ...
                    using (var aUserGroupRt = new UserGroupRT())
                    {
                        ...
                        userRegistration.UserGroupID = userGroup.FirstOrDefault(x => x.TypeID == Convert.ToInt32(EnumCollection.UserGrpType.Add_Giver)).IID;
                    }
