<%@ Page Title="Log in" Language="C#" MasterPageFile="~/DefaultMaster.Master" AutoEventWireup="true"
    CodeBehind="LoginPage.aspx.cs" Inherits="OH.Web.Account.LoginPage" Async="true" %>
                                                ...
                                                <div class="col-sm-12 col-md-10  col-md-offset-1 ">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            ...
                                                            <asp:TextBox ID="txtUserName" runat="server" class="form-control" placeholder="Username" name="loginname" type="text" autofocus="autofocus" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                    ...
                                                    <div class="form-group">
                                                         <asp:Button ID="Submit" runat="server" CommandName="Login" CssClass="btn btn-lg btn-primary btn-block" Text="LOGIN" />
