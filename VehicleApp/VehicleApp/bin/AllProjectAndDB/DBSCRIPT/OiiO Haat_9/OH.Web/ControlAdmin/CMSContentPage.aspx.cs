...
{
    public partial class CMSContentPage : System.Web.UI.Page
    {
        /// <summary>
        /// Author:Asiful Islam
        /// </summary>
        ...
        private object CmsImageUpload()
        {
            ...
            try
            {
                if (FileUploadImage.HasFile)
                {
                    ...
                    string path = Server.MapPath("~/Image/CMSPhoto/");
                    FileUploadHelper.BindImage(FileUploadImage, path, tempMatImageName);
                    imageUrl.ImageUrlTemp = "~/Image/CMSPhoto/" + tempMatImageName + Path.GetExtension(FileUploadImage.FileName);
