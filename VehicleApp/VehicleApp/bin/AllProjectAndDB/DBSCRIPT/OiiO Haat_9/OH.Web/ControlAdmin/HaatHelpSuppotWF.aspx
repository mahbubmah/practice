<%@ Page Title="" Language="C#" MasterPageFile="~/ControlAdmin/ControlAdminMaster.Master" AutoEventWireup="true" CodeBehind="HaatHelpSuppotWF.aspx.cs" Inherits="OH.Web.ControlAdmin.HaatHelpSuppotWF" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentAdminMain" runat="server">
       <section>
        <div class="container signpPage">
             <div class="row">
                <div class="col-sm-9">
                    <asp:Label ID="lblMassagehelpSupport" runat="server" Font-Size="Medium"></asp:Label>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-12">
                    <div class="well signpPageLeft">
                        <div class="addPostMang">
                            <fieldset class="adminFieldset">
                                <legend>Add/Edit Help Support Details</legend>
                                  <div class="row">
                                    <div class="form-group">
                                        <div class="col-sm-9 col-md-9">
                                            <asp:Label ID="lblCMSType" runat="server" CssClass="control-label">Help Support Type</asp:Label>
                                            <asp:DropDownList ID="ddlHelpSupportTypeID" runat="server" Height="100%" class="form-control"></asp:DropDownList>
                                              <asp:RequiredFieldValidator ID="RequiredFieldValidator1" InitialValue="-1" runat="server" ErrorMessage="Please select Help Support Type"   ControlToValidate="ddlHelpSupportTypeID" ForeColor="Red" ValidationGroup="gen"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                                </div>
                                     <div class="row">
                                    <div class="form-group">
                                        <div class="col-sm-9 col-md-9">
                                            <asp:Label ID="lblTitle" runat="server" CssClass="control-label">Help Support Title</asp:Label>
                                            ...
                                            <asp:RequiredFieldValidator ID="rbfGiudeLineDetailTitle" runat="server" ControlToValidate="txtTitle" ForeColor="Red"
                                                ErrorMessage="PLease enter Help Support Title"
                                   ...
                                   <div class="row">
                                    <div class="form-group">
                                        <div class="col-sm-9 col-md-9 col-lg-9">
                                            <asp:Label ID="lblDescription" runat="server" CssClass="control-label">Help Support Description (Not More than Three(3) Lines)</asp:Label>
                                 ...
                                 <div class="row">
                                    <div class="form-group">
                                        <div class="col-sm-9 col-md-9">
                                            <asp:Label ID="lblImageUpload" runat="server" CssClass="control-label">Upload Image For Help Support (Optional)</asp:Label>
                ...
                <div class="col-xs-12">
                    <div class="well signpPageLeft">
                        <div class="addPostMang">
                            <fieldset class="adminFieldset">
                                <legend>Help Support List</legend>
                                  <asp:ListView ID="lvhelpSupport" runat="server" DataKeyNames="IID" OnPagePropertiesChanging="lvhelpSupport_PagePropertiesChanging" >
                    <LayoutTemplate>
                        <table class="table table-bordered table-hover" style="margin-bottom: 0px;">
                            <thead>
                                <tr runat="server">
                                    ...
                                    <th class="col-xs-1">Help Support Type
                                    </th>
                    ...
                    <ItemTemplate>
                        <tr runat="server">
                                            ...
                                            <td>
                                                ...
                                                <asp:Label ID="Label4" runat="server" Text='<%#Enum.Parse(typeof(OH.Utilities.EnumCollection.HelpSupportType), Eval("HelpSupportTypeID").ToString()).ToString().Replace("_"," ")%>'></asp:Label>
                                            </td>
                                           
                                            <td>
                                                <div class="thumbnail">
                                                    <asp:Image runat="server" ID="OtherContentimg" Width="102" Height="60" ImageUrl='<%# Eval("Image") %>' alt="Image" />
                ...
                <asp:DataPager ID="dataPagerhelpSupport" runat="server" PagedControlID="lvhelpSupport"
                    PageSize="10" OnPreRender="dataPagerhelpSupport_PreRender"   >
                    <Fields>
