<%@ Page Title="" Language="C#" MasterPageFile="~/ControlAdmin/ControlAdminMaster.Master" AutoEventWireup="true" CodeBehind="OiiOhaatPage.aspx.cs" Inherits="OH.Web.ControlAdmin.OiiOhaatPage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentAdminMain" runat="server">
    ...
    <div class="container adminPagewrp">
        ...
        <div>
            <asp:Label ID="labelMessageOiiOHaaT" runat="server" Text="..."></asp:Label>
        </div>
         <div>
            <fieldset>
                  ...
                  <div class="row">
                    <div class="form-group col-xs-5">
                        <div class="input-group">
                            ...
                            <asp:TextBox ID="txtCompanyName" runat="server" Text="" class="form-controlWebSer" placeholder="Enter Company Name..."></asp:TextBox>
                        </div>
                    </div>
                </div>
                  <div class="row">
                    <div class="form-group col-xs-5">
                        <div class="input-group">
                            ...
                            <asp:TextBox ID="txtEmail" runat="server" Text="" class="form-controlWebSer" placeholder="Enter Email..."></asp:TextBox>
                        </div>
                    </div>
                </div>
                  <div class="row">
                    <div class="form-group col-xs-5">
                        <div class="input-group">
                            ...
                            <asp:TextBox ID="txtAddress" TextMode="MultiLine" runat="server" Text="" class="form-controlWebSer" placeholder="Enter Address..."></asp:TextBox>
                        </div>
                    </div>
                </div>
                  <div class="row">
                    <div class="form-group col-xs-5">
                        <div class="input-group">
                            ...
                            <asp:TextBox ID="txtPhone" TextMode="Number" runat="server" Text="" class="form-controlWebSer" placeholder="Enter Phone..."></asp:TextBox>
                        </div>
                    </div>
                </div>
                  <div class="row">
                ...
                <asp:TextBox ID="txtHoldImagePath" runat="server"></asp:TextBox>
                    ...
                    <div class="form-group col-xs-5">
                        <div class="input-group">
                            <span class="input-group-addon">Upload OiiOHaaT Logo
                            </span>
                ...
                <asp:TextBox ID="txtHoldImagePathForLoginLogo" runat="server"></asp:TextBox>
                    ...
                    <div class="form-group col-xs-5">
                        <div class="input-group">
                            <span class="input-group-addon">Upload Login Logo
                            </span>
                            <asp:FileUpload ID="FileUploadImageForLoginLogo" runat="server" class="form-controlWebSer"/>
                        </div>
                    </div>
                </div>
                 ...
                 <div class="row">
                    <div class="form-group col-xs-5">
                        <div class="input-group">
                            <asp:CheckBox ID="chkOiiOhaatActv" runat="server" Text=" &nbsp Is Active"/>
                        </div>
                    </div>
                </div>
           ...
           <div>
            <fieldset>
                ...
                <asp:ListView ID="lvHaaTContent" runat="server" DataKeyNames="IID" OnItemCommand="lvHaaTContent_ItemCommand" OnPagePropertiesChanging="lvHaaTContent_PagePropertiesChanging"  >
                    <LayoutTemplate>
                        ...
                        <tr id="trBody" runat="server">
                            ...
                            <td style="text-align: left">
                                ...
                                <asp:LinkButton ID="lnkBtnName" runat="server" CausesValidation="false" Text='<%#Bind("CompanyName")%>'
                                 CommandArgument='<%# Bind("IID") %>' CommandName="EditHaaTContent"></asp:LinkButton>
                            </td>
                            <td>
                ...
                <asp:DataPager ID="dataPagerContent" runat="server" PagedControlID="lvHaaTContent"
