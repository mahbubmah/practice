<%@ Page Title="" Language="C#" MasterPageFile="~/ControlAdmin/ControlAdminMaster.Master" AutoEventWireup="true" CodeBehind="PoliceStationWF.aspx.cs" Inherits="OH.Web.ControlAdmin.PoliceStationWF" %>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="adminFieldset">
                ...
                <div class="clearfix">
                    <asp:CheckBox ID="chkIsRemovedPoliceStation" runat="server" Text=" &nbsp IsRemoved" />
                </div>
                    <div class="clearfix">
                    </div>
                    <div class="row">
...
<%--                        <asp:DropDownList ID="ddlDistrict" runat="server" CssClass="sysTextBox"
                            Width="100%">
                        </asp:DropDownList>--%>
