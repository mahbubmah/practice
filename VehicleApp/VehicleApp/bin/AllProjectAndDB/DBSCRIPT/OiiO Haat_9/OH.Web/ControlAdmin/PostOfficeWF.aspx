<%@ Page Title="" Language="C#" MasterPageFile="~/ControlAdmin/ControlAdminMaster.Master" AutoEventWireup="true" CodeBehind="PostOfficeWF.aspx.cs" Inherits="OH.Web.ControlAdmin.PostOfficeWF" %>
            ...
            <fieldset>
                    ...
                    <div class="form-group col-xs-5">
                        <div class="input-group">
                            ...
                            <asp:RequiredFieldValidator ID="rfvPostOfficeCode" runat="server"
                                ...
                                ToolTip="*" Display="Dynamic" ValidationGroup="PostOfficeValidationGroup" ErrorMessage="Enter Post Office Code...">*</asp:RequiredFieldValidator>
                            </span>
                    ...
                    <div class="form-group col-xs-5">
                        <div class="input-group">
                            ...
                            <asp:RequiredFieldValidator ID="rfvPostOfficeName" runat="server"
                                ...
                                ToolTip="*" Display="Dynamic" ValidationGroup="PostOfficeValidationGroup" 
                                ErrorMessage="Enter Post Office Name...">*</asp:RequiredFieldValidator>
                            </span>
                    ...
                    <div class="form-group col-xs-5">
                        <div class="input-group">
                            ...
                            <asp:RequiredFieldValidator ID="rfvCountry" runat="server"
                                ...
                                ToolTip="*" Display="Dynamic" ValidationGroup="PostOfficeValidationGroup"
                                ErrorMessage="Enter Applicable Country...">*</asp:RequiredFieldValidator>
                            </span>
                    ...
                    <div class="form-group col-xs-5">
                        <div class="input-group">
                            ...
                            <asp:RequiredFieldValidator ID="rfvDivOrState" runat="server"
                                ...
                                ToolTip="*" Display="Dynamic" ValidationGroup="PostOfficeValidationGroup"
                                ErrorMessage="Enter Division Or State...">*</asp:RequiredFieldValidator>
                            </span>
                    ...
                    <div class="form-group col-xs-5">
                        <div class="input-group">
                            ...
                            <asp:RequiredFieldValidator ID="rfvDistrict" runat="server"
                                ...
                                ToolTip="*" Display="Dynamic" ValidationGroup="PostOfficeValidationGroup"
                                ErrorMessage="Enter District...">*</asp:RequiredFieldValidator>
                            </span>
                ...
                <div class="row">
                    <div class="form-group col-xs-5">
                        <div class="input-group">
                            ...
                            <asp:RequiredFieldValidator ID="rfvPoliceStation" runat="server"
                                ...
                                ToolTip="*" Display="Dynamic" ValidationGroup="PostOfficeValidationGroup"
                                ErrorMessage="Enter Police Station...">*</asp:RequiredFieldValidator>
                            </span>
                            <asp:TextBox ID="txtPoliceStation" runat="server" Text="" class="form-controlWebSer" placeholder="Search Police Station..."></asp:TextBox>
                        </div>
                    </div>
                    <div style="visibility: hidden">
                  ...
                  <div class="row">
                    <div class="form-group col-xs-5">
                        <div class="input-group">
                            <asp:CheckBox ID="chkPoliceStationActv" runat="server" Text=" &nbsp Is Remove"/>
                        </div>
                    </div>
                </div>
                    ...
                    <ItemTemplate>
                        <tr id="trBody" runat="server">
                            ...
                            <td style="text-align: left">
                                ...
                                <asp:LinkButton ID="lnkBtnName" runat="server" CausesValidation="false" Text='<%#Bind("PostOfficeName")%>'
                            ...
                            <td>
                                <asp:Label ID="lblDivisionOrStateID" runat="server" Text='<%# Bind("Division") %>'></asp:Label>
                            </td>
                            <td>
                                <asp:Label ID="lblDistrictID" runat="server" Text='<%# Bind("districtName") %>'></asp:Label>
                            </td>
                            <td>
                                <asp:Label ID="lblPoliceStationID" runat="server" Text='<%# Bind("policeStation") %>'></asp:Label>
                            </td>
                            <td>
                                <asp:CheckBox ID="chkIsRemovedPostOffice" runat="server" Checked='<%# Bind("IsRemoved") %>' Enabled="false"></asp:CheckBox>
                            </td>
<%--                             <td>
                                <asp:Label ID="LabelIsRemoved" runat="server" Text='<%# Bind("IsRemoved") %>'></asp:Label>
                            </td>--%>
                        </tr>
                    </ItemTemplate>
