...
{
    public partial class ShowRegisteredUserWF : System.Web.UI.Page
    {
        ...
        {
            if (e.CommandName == "EditRegisteredUser")
            {
                try
                {
                   
                    Session["RegistereduserID"] = Convert.ToInt32(e.CommandArgument);
                    hdShowRegisteredUserID.Value = Session["RegistereduserID"].ToString();
                    Response.Redirect("~/ControlAdmin/ShowAdGiverTracingForRegisteredUserWF.aspx");
