            ...
            <div class="row">
                <div class="form-group col-xs-5">
                    <div class="input-group">
                        ...
                        <asp:TextBox ID="txtUserGrpName" runat="server" class="form-control" placeholder="Enter User Group Name..." Height="30px" Width="229px"></asp:TextBox>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="form-group col-xs-5">
                    <div class="input-group">
                        ...
                        <asp:DropDownList ID="DropDownTypeID" runat="server" class="form-control" Height="30px" Width="229px"  ValidationGroup="UserValidationGroup">
