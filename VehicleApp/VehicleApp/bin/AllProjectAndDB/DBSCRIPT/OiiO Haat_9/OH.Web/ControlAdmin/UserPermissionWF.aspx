<%@ Page Title="" Language="C#" MasterPageFile="~/ControlAdmin/ControlAdminMaster.Master" AutoEventWireup="true" CodeBehind="UserPermissionWF.aspx.cs" Inherits="OH.Web.ControlAdmin.UserPermissionWF" %>
            ...
            <div class="row">
                <div class="form-group col-xs-4">
                    <div class="input-group">
                     ...
                     <asp:DropDownList ID="dropDownListGroupName" CssClass="form-control" runat="server" Height="30px" Width="229px"></asp:DropDownList></div>
                </div>
            </div>
            <div class="row">
                <div class="form-group col-xs-4">
                    <div class="input-group">
                        ...
                        <asp:DropDownList ID="dropDownListURLList" CssClass="form-control" runat="server" Height="30px" Width="229px"></asp:DropDownList></div>
                    </div>
                </div>
