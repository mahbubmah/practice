<%@ Page Title="" Language="C#" MasterPageFile="~/InnerMasterPage.Master" AutoEventWireup="true" CodeBehind="ManageYourAds.aspx.cs" Inherits="OH.Web.ManageYourAds" %>
                        ...
                        <div class="formHeadBorder">
                            ...
                            <div class="form-group">
                                <div style="float: right">
                                    <asp:Button ID="btnArchive" runat="server" Text="My archive" OnClick="btnArchive_Click" CssClass="btn btn-primary"
                                        ValidationGroup="cValidationGroup"></asp:Button>
                                </div>
                                <h3>Manage my ads</h3>
                    ...
                    <div class="col-sm-12">
                        <div class="manageAdd">
                            <div class="addPostMang">
                                <h4>
                                    <asp:Label ID="labelAdCount" runat="server" Text=""></asp:Label></h4>
                                <div class="table-responsive gridViewHaat">

                                    <asp:ListView ID="lvMaterial" runat="server" DataKeyNames="IID"
                                        OnItemCommand="lvMaterial_ItemCommand" OnPagePropertiesChanging="lvMaterial_PagePropertiesChanging" OnPreRender="dataPagerMaterial_PreRender">
                                                ...
                                                <td style="text-align: center">
                                                    <td>
                                                        <p data-placement="top" data-toggle="tooltip" title="Edit">
                                                            <asp:LinkButton ID="lnkBtnName" runat="server" CausesValidation="false" class="btn btn-primary btn-xs" data-title="Edit" 
                                                                CommandArgument='<%# Bind("IID") %>' CommandName="EditMaterial"><i class="fa fa-pencil-square-o"></i></asp:LinkButton>
                                                    ...
                                                    <td>
                                                        <p data-placement="top" data-toggle="tooltip" title="Delete">
                                                            <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="false" class="btn btn-danger btn-xs" data-title="Delete"  OnClientClick="return confirm('Are you sure to delete?');"
                                                                CommandArgument='<%# Bind("IID") %>' CommandName="DeleteMaterial"><i class="fa fa-trash"></i></asp:LinkButton>
                                                        </p>
                                                    </td>
                                    ...
                                    <asp:DataPager ID="dataPagerMaterial" runat="server" class="pagination pull-right pagItem" PagedControlID="lvMaterial"
